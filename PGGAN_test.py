...
class PGGAN(object):
    ...
    def build_model_PGGan(self):
        ...
        self.rgb_saver = tf.train.Saver(self.d_vars_n_2 + self.g_vars_n_2)
    ...
    #    self.G_loss, var_list=self.g_vars)
        ...
        with tf.Session(config=config) as sess:
            ...
            for xx in range(1,500,1):
                ...
                #pdb.set_trace()
                dirname = '/home/parimala/Desktop/progressive_growing_of_gans_tensorflow-master_NIQE_Based_approach/All_generated_samples_NIQE_128/'
                for i in range(64): 
                    dd=fake_image[i,:,:,:]
