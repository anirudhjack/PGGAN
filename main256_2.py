...
flags.DEFINE_string("OPER_NAME", "PGGAN_without_regularizer", "the name of experiments")
flags.DEFINE_integer("OPER_FLAG", 0, "Flag of opertion: 0 is for training ")
flags.DEFINE_string("path" , './data_crop_256', "Path of training data, for example /home/hehe/")
...
flags.DEFINE_integer("flag", 3, "FLAG of gan training process")
...
if __name__ == "__main__":
    ...
    if FLAGS.OPER_FLAG == 0:
        ...
        for i in range(FLAGS.flag):
            ...
            sample_path22 = "./output/{}/{}/Indiaviual_sample_{}_{}".format(FLAGS.OPER_NAME, FLAGS.OPER_FLAG, fl[i], t)
            ...
            pggan = PGGAN(batch_size=FLAGS.batch_size, max_iters=max_iterations[i],
                            ...
                            sample_path=sample_path,sample_path2=sample_path22, log_dir=root_log_dir, learn_rate=FLAGS.learn_rate, lam_gp=FLAGS.lam_gp, lam_eps=FLAGS.lam_eps, PG= fl[i],
    ...
    #if test == 1:
    #    t = False 
    #    pggan_checkpoint_dir_write = "./output/{}/model_pggan_{}/{}/".format(FLAGS.OPER_NAME, 0, 6])
    #    sample_path = "./output/{}/{}/sample_{}_{}".format(FLAGS.OPER_NAME, 0, 6, t)
    #    mkdir_p(pggan_checkpoint_dir_write)
    #    mkdir_p(sample_path)
    #    pggan_checkpoint_dir_read = "./output/{}/model_pggan_{}/{}/".format(FLAGS.OPER_NAME, FLAGS.OPER_FLAG, r_fl[i])#
